...
const HomePage = ({character, updatePlayer, music, soundOn, soundOff, musicIsPlaying}) => {
    ...
    return (
        <div>
            <MusicButton music={music} soundOff={soundOff} soundOn={soundOn}  musicIsPlaying={musicIsPlaying}/>
